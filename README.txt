...
Każdy z zaimplementowanych modeli jest zbudowany tak, że jest możliwość porównania wpływu długości komórek na przepływność pojazdów. W celu prezentacji zebranych danych generujemy diagramy fundamentalne pokazujące zależność przepływności od gęstości na drodze.
